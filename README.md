...
- **`calculate.go`**: A standalone HTTP service (running on port 9091) that implements the reverse-engineered folding algorithm (by nmqx and gemini) to calculate the `fa` parameter.
